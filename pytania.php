...
if ($number == 1){
    ...
    $sql = "INSERT INTO `gracze` (`nr`, `login`, `wynik`) VALUES ('', '$login', '')";
    $insert_gracz = $mysqli->query($sql) or die($mysqli->error.__LINE__);
}else{}
...
<html lang="en">
    ...
    <body>
       ...
       <form method="POST" action="process.php">
        ...
        <button type="submit" value="Submit" class="button button1">Następne pytanie</button></div>
